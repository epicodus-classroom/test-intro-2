...
If you don't need to use a PAT yet (because it's not your first day of Epicodus), there's no need to copy this yet. You can refer back to this lesson when you get to [Practice: GitHub Remote Repositories](https://www.learnhowtoprogram.com/introduction-to-programming/git-html-and-css/practice-github-remote-repositories) on your first day of class.

## [Using a PAT](#using-a-pat)

---

In [Practice: GitHub Remote Repositories](https://www.learnhowtoprogram.com/introduction-to-programming/git-html-and-css/practice-github-remote-repositories), you'll push code to a remote repository (in your GitHub account) for the first time.
